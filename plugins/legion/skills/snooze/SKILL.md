...
name: snooze
description: |
  Session wind-down with team memory consolidation. Reviews the session, boosts useful reflections, cross-pollinates insights to other agents, closes out bullpen conversations, and stores a consolidated session summary. Like Anthropic's auto-dream but for a team, not a solo agent.
version: 1.0.0
user-invocable: true
